...
class ResnetBlock2D(nn.Module):
    ...
    def forward(
        ...
        if hidden_states.shape[3]>=4096:
            #print(f'conv1d resnet last layer over 4096 pixel width splitW_cirConv enxingxiong')
            ...
            hidden_states = splitW_cirConv(hidden_states, scale, self.conv1)
        else:
